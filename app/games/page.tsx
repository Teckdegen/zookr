...
const GAMES: GameDef[] = [
  ...
  // ── COMING SOON — Solo vs House ──────────────────────────────────────────
  {
    ...
    mode: 'solo', players: '1 vs house', href: '#', live: false,
    icon: <SkullIcon size={32} className="text-[#7A6E58]" />,
  },
  {
  ...
  },
  {
    ...
    mode: 'solo', players: '1 vs house', href: '#', live: false,
    icon: <SwordIcon size={32} className="text-[#7A6E58]" />,
  },

  // ── COMING SOON — PvP (losers pay winners, house takes 20%) ─────────────
  {
    ...
    mode: '1v1', players: '1v1', href: '#', live: false,
    icon: <SwordIcon size={32} className="text-[#7A6E58]" />,
  },
  {
    ...
    mode: 'pvp', players: '2–5 players', href: '#', live: false,
    icon: <SkullIcon size={32} className="text-[#7A6E58]" />,
  },
  {
    ...
    mode: 'pvp', players: '2–4 players', href: '#', live: false,
    icon: <DiceIcon size={32} value={6} className="text-[#7A6E58]" />,
  },
  {
    ...
    mode: 'pvp', players: '2–10 players', href: '#', live: false,
    icon: <SkullIcon size={32} className="text-[#7A6E58]" />,
  },
  {
    ...
    mode: 'pvp', players: '2–4 players', href: '#', live: false,
    icon: <SkeletonHead size={32} className="text-[#7A6E58]" />,
  },
  {
    ...
    mode: 'pvp', players: '2–8 players', href: '#', live: false,
    icon: <SkullIcon size={32} className="text-[#7A6E58]" />,
  },
  {
    ...
    mode: '1v1', players: '1v1', href: '#', live: false,
    icon: <DiceIcon size={32} value={5} className="text-[#7A6E58]" />,
  },
  {
  ...
  },
  {
    ...
    mode: 'pvp', players: '4 players', href: '#', live: false,
    icon: <SkullIcon size={32} className="text-[#7A6E58]" />,
  },
  {
    ...
    mode: 'pvp', players: '3–8 players', href: '#', live: false,
    icon: <SwordIcon size={32} className="text-[#7A6E58]" />,
  },
  {
  ...
  return (
    <AppLayout active="play">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-8">
        ...
        <Section title="PvP — Coming Soon (Losers Pay Winners)" games={pvp} />
        <Section title="Solo vs House — Coming Soon" games={solo} />
      </div>
    </AppLayout>
  )
}
