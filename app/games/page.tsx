...
const GAMES: GameDef[] = [
  ...
  // ── PvP (losers pay winners, house takes 20%) ────────────────────────────
  {
    ...
    mode: '1v1', players: '1v1', href: '/game/token-duel', live: true,
    icon: <SwordIcon size={32} className="text-[#DC143C]" />,
  },
  {
    ...
    mode: 'pvp', players: '2–5 players', href: '/game/death-race', live: true,
    icon: <SkullIcon size={32} className="text-[#DC143C]" />,
  },
  {
    ...
    mode: 'pvp', players: '2–4 players', href: '/game/ghost-dice', live: true,
  ...
  },
  {
    ...
    mode: 'pvp', players: '2–10 players', href: '/game/bone-raffle', live: true,
    icon: <SkullIcon size={32} className="text-[#DC143C]" />,
  },
  {
    ...
    mode: 'pvp', players: '2–4 players', href: '/game/dead-mans-draw', live: true,
    icon: <SkeletonHead size={32} className="text-[#DC143C]" />,
  },
  {
    ...
    mode: 'pvp', players: '2–8 players', href: '/game/valhalla-roulette', live: true,
    icon: <SkullIcon size={32} className="text-[#DC143C]" />,
  },
  {
    ...
    mode: '1v1', players: '1v1', href: '/game/warrior-dice', live: true,
  ...
  },
  {
    ...
    mode: '1v1', players: '1v1', href: '/game/bone-crusher', live: true,
    icon: <SwordIcon size={32} className="text-[#DC143C]" />,
  },
  {
    ...
    mode: '1v1', players: '1v1', href: '/game/arena-duel', live: true,
    icon: <SwordIcon size={32} className="text-[#DC143C]" />,
  },
  {
    ...
    mode: 'pvp', players: '2–4 players', href: '/game/night-hunt', live: true,
    icon: <SkeletonHead size={32} className="text-[#DC143C]" />,
  },
  {
    ...
    mode: 'pvp', players: '4 players', href: '/game/gold-rush', live: true,
    icon: <SkullIcon size={32} className="text-[#DC143C]" />,
  },
  {
    ...
    mode: 'pvp', players: '3–8 players', href: '/game/last-warrior', live: true,
    icon: <SwordIcon size={32} className="text-[#DC143C]" />,
  },
  {
    ...
    mode: 'pvp', players: '2–4 players', href: '/game/valhalla-draft', live: true,
    icon: <SkeletonHead size={32} className="text-[#DC143C]" />,
  },
  {
    ...
    mode: 'pvp', players: '4 players', href: '/game/death-wheel', live: true,
    icon: <SkullIcon size={32} className="text-[#DC143C]" />,
  },
]
